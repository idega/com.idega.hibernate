...
/**
 * <p>
 * Class for initializing the Hibernate EJB3 EntityManager within idegaWeb ePlatform
 * </p>
...
public class EntityManagerUtil implements EntityManagerProvider{
    ...
    public static void configure(){
        try {
	     ...
	     loggerConnect.fine("In EntityManagerUtil try-clause via loggerConnect DEBUG*****");
            ...
            System.err.println("EntityManagerUtil: Initial SessionFactory creation failed." + ex);
